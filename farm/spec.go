...
// ChoiceCount is one objective and how many times the model has chosen this
// run. The full sentence, not the kind: "go to pallet town" chosen six
...
// PokePilot, never accepted from the model or a run ID. Validation does not
// interpret .state contents.
