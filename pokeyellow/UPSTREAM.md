...
The Pokemon Yellow disassembly, from https://github.com/pret/pokeyellow at
commit `e89ead1`. This is the source of every Yellow fact this project labels
DERIVED.
...
they could open. It is now. See `docs/POKEYELLOW.md` for the question -> file
map.
...
`roms/pokemon_yellow.gb` is byte-identical to what this tree builds
(sha1 `cc7d03262ebfaf2f06772c1a480c7d9d5f4a38e1`), so it describes the exact
...
the commit — do not patch files in place, or the tree stops describing the ROM.
