...
// ParseGoal accepts the stable CLI/farm spelling for run goals.
//
//   elite-four
//   badges:8
//   reach:cerulean city
...
//   item:potion
//
// Empty input means no deterministic goal and preserves the existing
// planner-directed run behaviour.
