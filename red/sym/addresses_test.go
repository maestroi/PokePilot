...
func TestAddressesMatchSymbolFile(t *testing.T) {
	...
	pairs := []struct {
		...
		{"wEnemyMonAttackMod", EnemyMonAttackMod},
		{"wEnemyMonDefenseMod", EnemyMonDefenseMod},
		{"wEnemyMonSpecies", EnemyMonSpecies},
		{"wEnemyMonLevel", EnemyMonLevel},
		{"wEnemyMonType1", EnemyMonType1},
		{"wEnemyMonStatus", EnemyMonStatus},
		{"wBattleMonStatus", BattleMonStatus},
		{"wBattleType", BattleType},
		{"wEnemyMonType2", EnemyMonType2},
		{"wBattleMonType1", BattleMonType1},
		{"wBattleMonType2", BattleMonType2},
		...
		{"wTopMenuItemY", TopMenuItemY},
		{"wTopMenuItemX", TopMenuItemX},
		{"wCurrentMenuItem", CurrentMenuItem},
		{"wMaxMenuItem", MaxMenuItem},
		{"wListScrollOffset", ListScrollOffset},
		{"wTextBoxID", TextBoxID},
		{"wFontLoaded", FontLoaded},
		{"wJoyIgnore", JoyIgnore},
		{"wEnteringCableClub", EnteringCableClub},
		{"wCableClubDestinationMap", CableClubDestinationMap},
		{"wUpdateSpritesEnabled", UpdateSpritesEnabled},
		{"wItemList", ItemList},
		{"wItemQuantity", ItemQuantity},
		{"wMaxItemQuantity", MaxItemQuantity},
		{"wChosenMenuItem", ChosenMenuItem},
		{"wMenuExitMethod", MenuExitMethod},
		{"hMoney", Money},
		{"hJoyHeld", JoyHeld},
