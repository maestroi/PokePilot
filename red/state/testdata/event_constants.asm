; Event flag indices from the pokered decompilation.
; Verbatim copy of constants/event_constants.asm; see event_constants_test.go.
; pokered commit: 0cd19d3b877b7dc66d12c7050bed9a7f38154d4b
