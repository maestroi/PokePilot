...
// run-3ecf4m4kv1nv71il1djnor7ur0 (triage:8ebf8a44a95c3566): a stationary
...
// connection first and Traverse exhausted the re-plan budget. As a gate it
// must leave via Route 14 and only take the north seam once ordinary walking
// can reach it.
