...
func init() {
	...
	newFacts := []byte(`<div><span>Farm default</span><strong>registry-selected · endpoint model discovered</strong></div><div><span>4090</span><strong>switchable managed deployments · manual</strong></div><div><span>LAN CPU</span><strong>configured fallback / manual</strong></div>`)
