...
func main() {
	...
	session := flag.String("session", "", "broker session id shared with the emulator")
	peerID := flag.String("peer-id", "virtual-trader", "broker peer id")
