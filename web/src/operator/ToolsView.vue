...
import { deploymentOptionLabel, deploymentSelectable, preferredDeployment } from './llmDeployments'
...
watch(deployments, (next) => {
  ...
  form.llm_deployment = preferredDeployment(next, form.llm_deployment)
}, { immediate: true })
